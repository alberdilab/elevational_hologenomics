...
```{r mixed_models_richness_df, echo=FALSE, message=FALSE, warning=FALSE,fig.height=4, fig.width=10, fig.fullwidth=TRUE}
richness_cor %>%
  tt()
```
...
```{r mixed_models_neutral_df, echo=FALSE, message=FALSE, warning=FALSE,fig.height=4, fig.width=10, fig.fullwidth=TRUE}
neutral_cor %>%
  tt()
```
...
```{r mixed_models_phylo_df, echo=FALSE, message=FALSE, warning=FALSE,fig.height=4, fig.width=10, fig.fullwidth=TRUE}
phylo_cor %>%
  tt()
```
...
```{r mixed_models_func_df, echo=FALSE, message=FALSE, warning=FALSE,fig.height=4, fig.width=10, fig.fullwidth=TRUE}
func_cor %>%
  tt()
```
...
bind_rows(positive,negative) %>%
  ...
  ggplot(aes(x=mean, y=fct_rev(trait), xmin=p1, xmax=p9, color=Function)) +
      geom_point() +
      geom_errorbar() +
      scale_color_manual(values = c("#debc14","#440526","#dc7c17","#172742","#00C19F","#619CFF","#A4006E","#FFCCCC","#357379","#6c7e2c","#d8dc69","#774d35","#db717d", "#dd3d2d","#c2a5cf","#00c0ff50" )) +
      theme_minimal() +
