#!/bin/bash
#SBATCH --job-name=hmsc_model2_250_1                   # Job name
#SBATCH --nodes=1
...
source activate /maps/projects/alberdilab/people/dlz554/hmsc/hmsc_env
...
load("hmsc/hmsc_zones.Rdata")

# Declare placeholders
modelname = "model2"
model = model_list$model2
fitname = "hmsc/fit_model2_250_1.Rdata"
convname = "hmsc/conv_model2_250_1.Rdata"
sample = 250
thin = 1
nchains = 4
...
save(psrf.beta.model2_250_1, psrf.gamma.model2_250_1, psrf.rho.model2_250_1, file=convname)
