...
```{r beta_div_richness_permutest_1, echo=TRUE, results = TRUE}
betadisper(beta_q0n$S, sample_metadata$Sampling_point) %>% permutest(., pairwise=TRUE) 
```

```{r beta_div_richness_adonis_1, echo=TRUE, results = TRUE}
...
```{r beta_div_neutral_permutest_1, echo=TRUE, results = TRUE}
betadisper(beta_q1n$S, sample_metadata$Sampling_point) %>% permutest(., pairwise=TRUE) 
```

```{r beta_div_neutral_adonis_1, echo=TRUE, results = TRUE}
...
```{r beta_div_phylo_permutest_1, echo=TRUE, results = TRUE}
betadisper(beta_q1p$S, sample_metadata$Sampling_point) %>% permutest(., pairwise=TRUE) 
```

```{r beta_div_phylo_adonis_1, echo=TRUE, results = TRUE}
...
```{r beta_div_nmds, echo=TRUE, results = TRUE}
p0<-beta_q0n$S %>%
...
```{r beta_div_nmds_plot, echo=TRUE, results = TRUE, fig.height=6, fig.width=15, fig.fullwidth=TRUE}
...
```{r beta_div_dk_data, echo=TRUE, results = TRUE}
...
```{r beta_div_dk_plot, echo=TRUE, results = TRUE, warning=FALSE, comment=FALSE, message=FALSE}
...
```{r beta_div_dk_plot_lm, echo=TRUE, results = TRUE, warning=FALSE, comment=FALSE, message=FALSE}
