...
```{r mixed_models_richness_df, echo=FALSE, message=FALSE, warning=FALSE}
richness_cor %>%
  tt()
```
...
```{r mixed_models_neutral_df, echo=FALSE, message=FALSE, warning=FALSE}
neutral_cor %>%
  tt()
```
...
```{r mixed_models_phylo_df, echo=FALSE, message=FALSE, warning=FALSE}
phylo_cor %>%
  tt()
```
...
```{r mixed_models_func_df, echo=FALSE, message=FALSE, warning=FALSE}
func_cor %>%
  tt()
```
