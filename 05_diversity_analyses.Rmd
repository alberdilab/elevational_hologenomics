...
```{r beta_div_richness_permutest, echo=TRUE, results = FALSE}
betadisper(beta_q0n$S, sample_metadata$Transect) %>% permutest(., pairwise=TRUE) 
```

```{r beta_div_richness_adonis, echo=TRUE, results = FALSE}
...
```{r beta_div_neutral_permutest, echo=TRUE, results = FALSE}
betadisper(beta_q1n$S, sample_metadata$Transect) %>% permutest(., pairwise=TRUE) 
```

```{r beta_div_neutral_adonis, echo=TRUE, results = FALSE}
...
```{r beta_div_phylo_permutest, echo=TRUE, results = FALSE}
betadisper(beta_q1p$S, sample_metadata$Transect) %>% permutest(., pairwise=TRUE) 
```

```{r beta_div_phylo_adonis, echo=TRUE, results = FALSE}
...
```{r beta_div_func_permutest, echo=TRUE, results = FALSE}
betadisper(beta_q1f$S, sample_metadata$Transect) %>% permutest(., pairwise=TRUE) 
```

```{r beta_div_func_adonis, echo=TRUE, results = FALSE}
...
```{r beta_div_boxplot_1, comment="", message=FALSE, warning=FALSE, fig.height=5, fig.width=10, fig.fullwidth=TRUE}
bxp1<-beta_div %>%
  pivot_longer(-Sampling_point, names_to = "metric", values_to = "value") %>%
  left_join(sample_metadata %>% select(Transect,Sampling_point, Elevation) %>% unique, by = "Sampling_point") %>%
  mutate(metric=factor(metric,levels=c("richness","neutral","phylogenetic","functional"))) %>%
...
```{r aisa_samples_1, echo=FALSE, results = TRUE, message=FALSE, warning=FALSE, comments=FALSE}
nrow(Aisa_transect)
```
...
```{r beta_div_aisa_reg, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_aisa_reg_1, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_aisa_reg_2, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_aisa_reg_3, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r aran_samples, echo=FALSE, results = TRUE, message=FALSE, warning=FALSE, comments=FALSE}
...
```{r beta_div_aran, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```
```{r beta_div_aran_reg, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_aran_reg_1, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_aran_reg_2,echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_aran_reg_3, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r sentein_samples, echo=FALSE, results = TRUE, message=FALSE, warning=FALSE, comments=FALSE}
...
```{r sentein_samples_1, echo=FALSE, results = TRUE, message=FALSE, warning=FALSE, comments=FALSE}
nrow(sentein_transect)
```

```{r beta_div_sentein, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_sentein_reg, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_sentein_reg_1, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_sentein_reg_2, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_sentein_reg_3, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r tourmalet_samples, echo=FALSE, results = TRUE, message=FALSE, warning=FALSE, comments=FALSE}
...
```{r tourmalet_samples_1, echo=FALSE, results = TRUE, message=FALSE, warning=FALSE, comments=FALSE}
...
```{r beta_div_tourmalet_reg, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_tourmalet_reg_1, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_tourmalet_reg_2, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r beta_div_tourmalet_reg_3, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r aisa_transect_pairwise_A, eval=FALSE, results=TRUE}
...
```{r aisa_transect_pairwise_B, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_aisa_b$S, Aisa_transect_B$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_aisa_b$S, Aisa_transect_B$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_aisa_b$S, Aisa_transect_B$Elevation, perm = 999)
pairwise.adonis(beta_div_func_aisa_b$S, Aisa_transect_B$Elevation, perm = 999)
```
...
```{r aisa_transect_pairwise_C, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_aisa_c$S, Aisa_transect_C$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_aisa_c$S, Aisa_transect_C$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_aisa_c$S, Aisa_transect_C$Elevation, perm = 999)
pairwise.adonis(beta_div_func_aisa_c$S, Aisa_transect_C$Elevation, perm = 999)
```
...
```{r aran_transect_pairwise_A, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_aran_a$S, Aran_transect_A$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_aran_a$S, Aran_transect_A$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_aran_a$S, Aran_transect_A$Elevation, perm = 999)
pairwise.adonis(beta_div_func_aran_a$S, Aran_transect_A$Elevation, perm = 999)
```
...
```{r aran_transect_pairwise_B, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_aran_b$S, Aran_transect_B$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_aran_b$S, Aran_transect_B$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_aran_b$S, Aran_transect_B$Elevation, perm = 999)
pairwise.adonis(beta_div_func_aran_b$S, Aran_transect_B$Elevation, perm = 999)
```
...
```{r aran_transect_pairwise_C, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_aran_c$S, Aran_transect_C$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_aran_c$S, Aran_transect_C$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_aran_c$S, Aran_transect_C$Elevation, perm = 999)
pairwise.adonis(beta_div_func_aran_c$S, Aran_transect_C$Elevation, perm = 999)
```
...
```{r aran_transect_pairwise_D, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_aran_d$S, Aran_transect_D$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_aran_d$S, Aran_transect_D$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_aran_d$S, Aran_transect_D$Elevation, perm = 999)
pairwise.adonis(beta_div_func_aran_d$S, Aran_transect_D$Elevation, perm = 999)
```
...
```{r aran_transect_pairwise_E, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_aran_e$S, Aran_transect_E$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_aran_e$S, Aran_transect_E$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_aran_e$S, Aran_transect_E$Elevation, perm = 999)
pairwise.adonis(beta_div_func_aran_e$S, Aran_transect_E$Elevation, perm = 999)
```
...
```{r sentein_transect_pairwise_A, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_sentein_a$S, sentein_transect_A$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_sentein_a$S, sentein_transect_A$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_sentein_a$S, sentein_transect_A$Elevation, perm = 999)
pairwise.adonis(beta_div_func_sentein_a$S, sentein_transect_A$Elevation, perm = 999)
```
...
```{r sentein_transect_pairwise_B, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_sentein_b$S, sentein_transect_B$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_sentein_b$S, sentein_transect_B$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_sentein_b$S, sentein_transect_B$Elevation, perm = 999)
pairwise.adonis(beta_div_func_sentein_b$S, sentein_transect_B$Elevation, perm = 999)
```
...
```{r sentein_transect_pairwise_C, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_sentein_c$S, sentein_transect_C$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_sentein_c$S, sentein_transect_C$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_sentein_c$S, sentein_transect_C$Elevation, perm = 999)
pairwise.adonis(beta_div_func_sentein_c$S, sentein_transect_C$Elevation, perm = 999)
```
...
```{r tourmalet_transect_pairwise_A, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_tourmalet_a$S, tourmalet_transect_A$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_tourmalet_a$S, tourmalet_transect_A$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_tourmalet_a$S, tourmalet_transect_A$Elevation, perm = 999)
pairwise.adonis(beta_div_func_tourmalet_a$S, tourmalet_transect_A$Elevation, perm = 999)
```
...
```{r tourmalet_transect_pairwise_B, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_tourmalet_b$S, tourmalet_transect_B$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_tourmalet_b$S, tourmalet_transect_B$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_tourmalet_b$S, tourmalet_transect_B$Elevation, perm = 999)
pairwise.adonis(beta_div_func_tourmalet_b$S, tourmalet_transect_B$Elevation, perm = 999)
```
...
```{r tourmalet_transect_pairwise_C, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_tourmalet_c$S, tourmalet_transect_C$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_tourmalet_c$S, tourmalet_transect_C$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_tourmalet_c$S, tourmalet_transect_C$Elevation, perm = 999)
pairwise.adonis(beta_div_func_tourmalet_c$S, tourmalet_transect_C$Elevation, perm = 999)
```
...
```{r tourmalet_transect_pairwise_D, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_tourmalet_d$S, tourmalet_transect_D$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_tourmalet_d$S, tourmalet_transect_D$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_tourmalet_d$S, tourmalet_transect_D$Elevation, perm = 999)
pairwise.adonis(beta_div_func_tourmalet_d$S, tourmalet_transect_D$Elevation, perm = 999)
```
...
```{r tourmalet_transect_pairwise_E, eval=FALSE, results=TRUE}
pairwise.adonis(beta_div_richness_tourmalet_e$S, tourmalet_transect_E$Elevation, perm = 999)
pairwise.adonis(beta_div_neutral_tourmalet_e$S, tourmalet_transect_E$Elevation, perm = 999)
pairwise.adonis(beta_div_phylo_tourmalet_e$S, tourmalet_transect_E$Elevation, perm = 999)
pairwise.adonis(beta_div_func_tourmalet_e$S, tourmalet_transect_E$Elevation, perm = 999)
```
...
```{r aisa_mean_1, eval=FALSE, results=TRUE}
# Merge all metrics
...
```{r aran_mean_1, eval=FALSE, results=TRUE}
# Merge all metrics
...
```{r sentein_mean_1, eval=FALSE, results=TRUE}
# Merge all metrics
...
```{r tourmalet_mean_1, eval=FALSE, results=TRUE}
# Merge all metrics
